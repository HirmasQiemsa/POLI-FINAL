                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ '/riwayat-pasien' }}">Riwayat Periksa</a></li>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th>Nama Dokter</th>
                                <td style="text-align:center;">{{ $data->periksa->daftarPoli->jadwalPeriksa->dokter->nama }}
                                </td>
                            </tr>
                            <tr>
                                <th>Hari Praktek</th>
                    ...
                    <a onclick="window.print()" class="btn btn-primary btn-block no-print">Cetak</a>
                </div>
                <!-- /.card-body -->
            </div>
        </section>
