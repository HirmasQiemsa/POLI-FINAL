    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info d-flex">
                        <a href="#" class="d-flex">Hi, {{ $pasien->nama }}</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashboard-pasien') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('daftar-poli') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('riwayat-pasien') }}" class="nav-link">
                        ...
                        {{-- logout --}}
                        <li class="nav-item">
                            <a href="{{ route('logout-pasien') }}" class="nav-link">
